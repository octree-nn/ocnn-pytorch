...
AUTOTUNE_CACHE_PATH = os.path.expanduser('~/.octconvt/autotune_cache.json')
...
class PersistentCacheAutoTuner:
    def __init__(
        ...
        self.warmup = warmup
        self.runs = runs
        self.verbose = verbose or os.getenv('kernels_AUTOTUNER_VERBOSE', '0') == '1'
...
def get_autotune_cache():
    ...
    walk_package('kernels', save_cache)
...
def load_autotune_cache(path_or_cache=None):
    ...
    walk_package('kernels', load_cache)
